...
CREATE DATABASE IF NOT EXISTS `db_berita` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_berita`;

-- Dumping structure for table db_berita.berita
...
-- Dumping structure for table db_berita.kategori
